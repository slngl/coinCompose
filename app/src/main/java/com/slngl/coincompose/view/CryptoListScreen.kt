package com.slngl.coincompose.view
...
import com.slngl.coincompose.viewmodel.CryptoListViewModel
        ...
        modifier = Modifier.fillMaxWidth()
            ...
            .clickable {
                navController.navigate(
                    route = "crypto_detail_screen/${cryptoListItem.currency}/${cryptoListItem.price}",
                )
            },
    ) {
        Text(
